...
const BriefTargetPriceTab = () => {
  return (
      <Box sx={{ overflowX:{xs:"auto", md:"none"},display: "flex",justifyContent: {md:'space-between', xs:"none",},gap:{xs:"10px"}}}>
...
export default BriefTargetPriceTab;